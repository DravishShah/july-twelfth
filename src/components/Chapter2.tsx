  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (obj) => {
        ...
        // This ScrollTrigger was created asynchronously (only after the
        // door model finished loading over the network). Any OTHER
        // ScrollTrigger on the page created before this one — including
        // Chapter4's scroll-lock, which fires immediately on mount — will
        // have measured the document without this pin's large spacer in
        // it, leaving their positions stale once the spacer is inserted.
        // Refreshing here corrects everyone's measurements against the
        // now-final layout.
      ...
      (progress) => {
        if (progress.total) {
          console.log(
            `[DoorChapter] Loading OBJ: ${Math.round(
      ...
      >
        <div ref={noteRef} style={{ opacity: 0 }}>
          ...
          >
            ...
            >
              <p style={{ margin: 0 }}>
                Funny how life never tells you when it's about to change.
                Sometimes it happens on an ordinary evening. It was your
                birthday in 2013. We reached the party early, everyone was
                talking, laughing, waiting for you. Then you walked through the
                door wearing that black dress, and suddenly nothing else in the
                room existed. There was only you.
              </p>

              {/* ---------------- PARAGRAPH 2 ---------------- */}

              <p style={{ margin: 0 }}>
                I kept telling myself it was only admiration. It wasn't.
                Somewhere between all those conversations, jokes, and memories,
                my heart had quietly crossed a line I never saw coming. I wasn't
                looking at the most beautiful girl in the room, I was looking at
                the person I wanted every tomorrow with.
              </p>
              ...
              >
                That was the day I realized that, somewhere along the way, my
                best friend had quietly become the love of my life.
              </p>
