...
// //
// // Two "doubt" moments, each shown as a glass card in a storm (drifting
// // clouds, falling rain, lightning). Click the card repeatedly to crack it —
// // cracks radiate procedurally from wherever you click, in a proper jagged
// // spiderweb pattern (not fixed shapes), and stay clipped inside the card's
// // own bounds. Enough clicks shatters it, phase two needs more clicks and
// // breaks harder (matching that phase being the tougher one). After both,
// // the storm clears into a photo card of the two of you.
// //
// // HOW TO CUSTOMIZE:
// //   - PHASES array below: the doubt line, the resolve line, and how many
// //     clicks each phase takes to break.
// //   - FINAL_PHOTO_SRC: your photo, currently pointing at public/we.png,
// //     shown in the closing card.
// //   - FINAL_CAPTION: the line under the photo.
// //   - The section label ("Chapter 04 · Two Storms") — placeholder, edit
// //     freely.
// //
// // TUNING NOTES:
// //   - CARD_WIDTH/CARD_HEIGHT     → card size (also the crack coordinate space)
// //   - RAIN_COUNT                 → rain density
// //   - clicksNeeded per phase     → how much clicking it takes to break
// // ─────────────────────────────────────────────────────────────────────────────
...
//   {
//     tag: "Phase one",
//     text: '"This will never work."',
//     resolve: "We made it through.",
//     clicksNeeded: 4,
//     breakDur: 0.8,
//   },
//   {
//     tag: "Phase two",
//     text: '"This time, it will really never work."',
//     resolve: "We made it through — again.",
//     clicksNeeded: 6,
//     breakDur: 1.2,
//   },
// ];
