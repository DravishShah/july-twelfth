...
const CONTENT = {
  ...
  paragraph1:
    "13 years ago, a confused boy almost didn't reply to your message. Thank everything in the universe that he did.",
  paragraph2:
    "You have been my Train Ride, my Vada Pav, my Patther... My Home.",
  paragraph3: (
    <>
      Next July, you won't just be my Patther. You'll be my{" "}
      <span
        style={{
